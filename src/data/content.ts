...
export const ALL_SERVICES: ServiceItem[] = [
  ...
  {
    id: 'architectural-floor-plans',
    title: 'Architectural Floor Plans & Working Drawings',
    slug: 'architectural-floor-plans',
    category: 'Architecture & Visualisation',
    description: 'Vastu-compliant dimensional floor layouts, furniture planning, and municipal submission drawings.',
    fullDetails: 'Precision architectural drawings engineered for optimal circulation, ventilation, and space utilization, adhering to local building codes and vastu principles.',
    keyFeatures: ['Dimensioned room-by-room floor plans', 'Vastu-compliant orientation and zoning', 'Door and window opening schedules', 'Ready for on-site execution and municipal approval'],
